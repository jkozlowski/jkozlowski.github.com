...
\item \textbf{Scala}: 4 months, completed \textbf{Functional Programming Principles in Scala} course organised by Martin Odersky; \textbf{scalaz} 
...
\begin{itemize}
\item Working on message persistence to a KDB database for a calculation/decision engine.  
\end{itemize}
